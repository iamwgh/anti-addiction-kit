...
#ifndef ANTIADDICTIONKIT_SWIFT_H
#define ANTIADDICTIONKIT_SWIFT_H
...
/// 未成年可玩开始时间（字符串，格式为<code>小时:分钟</code>，24小时进制，默认<code>20:00</code>）方便配置具体到分钟
@property (nonatomic, copy) NSString * _Nonnull minorPlayStart;
/// 未成年可玩结束时间（字符串，格式为<code>小时:分钟</code>，24小时进制，默认<code>21:00</code>）方便配置具体到分钟
@property (nonatomic, copy) NSString * _Nonnull minorPlayEnd;
/// 未成年除了节假日可玩日期
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull minorPlayDay;
/// 未成年人非节假日每日总时长 单位秒
